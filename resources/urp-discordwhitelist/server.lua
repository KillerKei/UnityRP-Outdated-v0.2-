--- Config ---
notWhitelistedMessage = "Please join the discord to play on the server. Discord: discord.gg/KqddPAhSRz" -- Message displayed when they are not whitelist with the role
