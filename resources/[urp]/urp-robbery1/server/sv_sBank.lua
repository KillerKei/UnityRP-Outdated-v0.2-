...
RegisterNetEvent('urp-robbery:smallBankAttempt')
AddEventHandler('urp-robbery:smallBankAttempt', function(bId)
...
AddEventHandler('urp-robbery:sBankBox', function(bId, iType)
