...
RegisterNetEvent('urp-robbery:attemptRegisterRobbery')
AddEventHandler('urp-robbery:attemptRegisterRobbery', function(sId, rId)
    ...
    TriggerClientEvent('urp-robbery:regSuccess', source)
end)
...
AddEventHandler('urp-robbery:attemptSafeRobbery', function(sId)
    ...
    TriggerClientEvent('urp-robbery:safeSuccess', source)
end)
