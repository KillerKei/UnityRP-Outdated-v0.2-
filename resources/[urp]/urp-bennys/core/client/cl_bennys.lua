...
local function saveVehicle()
	...
	local myCar = exports['urp-base']:FetchVehProps(veh)
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("urp-bennys:attemptPurchase", Player.id, Player.cash, type, upgradeLevel)
...
AddEventHandler("urp-bennys:purchaseSuccessful", function(cash)
    local LocalPlayer = exports["urp-base"]:getModule("LocalPlayer")
    local Player = LocalPlayer:getCurrentCharacter()
