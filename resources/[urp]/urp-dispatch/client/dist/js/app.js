            ...
            u = {
                ...
                methods: {
                    setGPSMarker: function (t) {
                        void 0 !== t && fetch("http://urp-dispatch/setGPSMarker", { headers: { "Content-Type": "application/json" }, method: "POST", body: JSON.stringify({ gpsMarkerLocation: t }) });
                    },
                },
                computed: {
                    genderIcon: function () {
            ...
            x = {
                ...
                mounted: function () {
                    ...
                    window.addEventListener("keyup", function (e) {
                        27 === e.keyCode && t.showDispatchLog && ((t.showDispatchLog = !1), fetch("http://urp-dispatch/disableGui"));
                    });
                },
                created: function () {
                    var t = this;
