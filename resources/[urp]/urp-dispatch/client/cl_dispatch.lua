...
AddEventHandler('dispatch:clNotify', function(pNotificationData)
  local currentJob = exports['isPed']:isPed('job')
...
AddEventHandler("civilian:alertPolice",function(basedistance,alertType,objPassed,isGunshot,isSpeeder)
    ...
    if (alertType == "gunshot" or alertType == "gunshotvehicle") and not Job == 'police' then
      AlertGunShot()
    end
    ...
    if alertType == "robberyhouse" and not Job == 'police' then
      AlertCheckRobbery2()
    end
end)
