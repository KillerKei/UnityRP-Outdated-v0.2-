...
RegisterNetEvent('urp-weapons:destroyGroundWeapon')
AddEventHandler('urp-weapons:destroyGroundWeapon', function()
	DeleteEntity(weapon)
end)

RegisterNetEvent('urp-weapons:allowDrop')
AddEventHandler('urp-weapons:allowDrop', function()
	canDrop = true
end)

RegisterNetEvent('urp-weapons:dropweapon')
AddEventHandler('urp-weapons:dropweapon', function(AmountOfCurrentWeapon,weaponModel,rowID)
...
RegisterNetEvent('urp-weapons:doHandOver')
AddEventHandler('urp-weapons:doHandOver', function(weapon)
  --GiveWeaponToPed(PlayerPedId(), tonumber(weapon), 0, 0, false)
  TriggerEvent("attachWeapons")
end)

RegisterNetEvent('urp-weapons:dropWeaponSearch')
AddEventHandler('urp-weapons:dropWeaponSearch', function(weapon)
	--RemoveWeaponFromPed(PlayerPedId(),tonumber(weapon))
  TriggerEvent("attachWeapons")
end)


RegisterNetEvent('urp-weapons:giveweapon')
AddEventHandler('urp-weapons:giveweapon', function(toPlayer,AmountOfCurrentWeapon,weaponModel,rowID)
...
AddEventHandler('attachWeapons', function()
	...
	local currentWeapons = exports["urp-inventory"]:GetCurrentWeapons() 
	weapcount = 1
	local curw = GetSelectedPedWeapon(PlayerPedId())
