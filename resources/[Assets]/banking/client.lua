...
function openGui()
  ...
  bankanimation()
  Citizen.Wait(1400)
  TriggerEvent('banking:updateCash', exports['urp-base']:getModule("LocalPlayer"):getCurrentCharacter().cash, true)
...
AddEventHandler('banking:updateBalance', function(balance, show)
  local id = PlayerId()
  local LocalPlayer = exports["urp-base"]:getModule("LocalPlayer"):getCurrentCharacter()
