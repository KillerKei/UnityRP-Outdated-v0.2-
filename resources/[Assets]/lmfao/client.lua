		...
		--	end
			...
			if GetDistanceBetweenCoords(PlayerPos, 3825.82, 4441.26, 2.81, true) <= 5 then						
				...
				if JustPickedWeed or JustDriedWeed then
					...
					local wetbud = exports["urp-inventory"]:hasEnoughOfItem("driedbud",5,false)
					if wetbud then

						local finished = exports["urp-taskbar"]:taskBar(10000,"Packing Weed",false,false,playerVeh)
						if (finished == 100) then
