...
function URP.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		--TriggerServerEvent('urp-base:sv:player_control_set',URP.Controls.Current)
...
RegisterNetEvent("urp-base:cl:player_control")
AddEventHandler("urp-base:cl:player_control", function(controlTable)
