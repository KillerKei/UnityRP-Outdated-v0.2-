...
function URP.SpawnManager.Initialize(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("urp-base:spawnInitialized")
        TriggerServerEvent("urp-base:spawnInitialized")
...
RegisterNetEvent('urp-base:SwapChar')
AddEventHandler('urp-base:SwapChar', function()
...
function URP.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        --TriggerEvent("urp-base:initialSpawnModelLoaded")
        ...
        --if new then TriggerEvent("urp-base:newCharacterSpawned") end
        TriggerEvent("urp-base:playerSpawned")
...
AddEventHandler("urp-base:firstSpawn", function()
...
RegisterNetEvent('urp-base:clearStates')
AddEventHandler('urp-base:clearStates', function()
