...
AddEventHandler('server:givepass', function(gangid,newrank,cid)
    ...
    if tonumber(newrank) == 0 then
        ...
        TriggerClientEvent('urp-base:updateJob', target.playerSrc, "None", newrank)
        ...
        TriggerClientEvent('urp-base:updateJob', target.playerSrc, pCurrent[1].name, newrank)
        exports.ghmattimysql:execute('INSERT INTO __employees(`cid`, `giver`, `rank`, `name`, `business_id`) VALUES(?, ?, ?, ?, ?)', {cid, name, newrank, targetname, groupId})
    end
end)
...
AddEventHandler('server:gankGroup', function(gangid, cashamount, pId)
    ...
    TriggerEvent('urp-base:updateCharacterBank', pDepoAmount, pCitizenId, false, depoAmount)
...
AddEventHandler('server:givepayGroup', function(gangid, cashamount, cid)
    ...
    TriggerEvent('urp-base:updateCharacterBank', pDepoAmount, cId, true, depoAmount)
...
-- RegisterServerEvent('urp-phone:restart')
-- AddEventHandler('urp-phone:restart', function()
