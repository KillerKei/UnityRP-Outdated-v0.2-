...
RegisterNetEvent("urp-admin:RemoveRecent")
AddEventHandler("urp-admin:RemoveRecent", function(data)
    if data ~= nil then
...
RegisterNetEvent('urp-admin:teleportUser')
AddEventHandler('urp-admin:teleportUser', function(x, y, z)
